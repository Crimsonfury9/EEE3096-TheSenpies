...
def setup():
    ...
    GPIO.setup(btn_increase,GPIO.IN,GPIO.PUD_UP)
    GPIO.setup(btn_submit,GPIO.IN,GPIO.PUD_UP)
    ...
    GPIO.add_event_detect(btn_increase, GPIO.FALLING, callback=btn_increase_pressed, bouncetime=800)
